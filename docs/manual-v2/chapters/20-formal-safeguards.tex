...
The current suite contains twenty-one safe specifications. They are divided by
...
The check suite expects all twenty-three negative configurations to fail for the named
...
\begin{itemize}
    \item runs all twenty-one safe configurations;
    ...
    \item runs twenty-three negative configurations and requires each one to fail on
...
At the 15 August 2026 implementation synchronization point, representative
