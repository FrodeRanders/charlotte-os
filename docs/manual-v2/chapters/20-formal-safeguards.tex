...
The check suite expects all eighteen negative configurations to fail for the named
...
\begin{itemize}
    ...
    \item runs eighteen negative configurations and requires each one to fail on
