...
\texttt{spawn\_upgrade} is currently a kernel-side supervisor operation used by
the self-test. It loads the new service ELF, moves the state memory
...
down the old domain. The EL0 service manager can orchestrate
\texttt{OP\_HANDOFF}, but it cannot yet spawn the replacement domain without
kernel/self-test assistance.
