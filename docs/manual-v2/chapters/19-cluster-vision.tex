...
\begin{itemize}
    ...
    \item \texttt{notify}, which verifies a signed \texttt{CDEPLOY3}
        ...
        capability grants without copying an ELF through Raft.
\end{itemize}
...
\texttt{CDEPLOY3}; the reader retains compatibility with \texttt{CDEPLOY1}
and \texttt{CDEPLOY2}.
