...
placement. The implemented initial policy chooses the leader admitting the
descriptor; a nonzero key remains an explicit pin. Full signed artifact names
...
Automatic placement currently covers one replica on the admitting leader. A
