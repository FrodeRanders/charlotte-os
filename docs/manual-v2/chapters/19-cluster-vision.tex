...
Deployment ingress and the UTC time service also implement the cooperative
path. Ingress stops accepting connections, cancels an idle bounded receive,
and drops its owned listener and service connections. Time closes its public
endpoint and unwinds any pending NTP call, UDP socket, and persistence
connection as one owning scope. Already admitted deployment work may finish
inside the signed grace, but neither service begins new work after observing
