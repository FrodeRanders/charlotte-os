...
\begin{itemize}
    ...
    \item \texttt{notify}, which verifies a signed \texttt{CDEPLOY1}
        descriptor and commits its opaque central-object key, digest, target,
        sequence, and capability grants without copying an ELF through Raft.
\end{itemize}
...
outer signature and every \texttt{CDEPLOY1} signature. A follower relays the
