...
\architecturewidefigure{cooperative-deployment-shutdown}
    {Bounded cooperative shutdown followed by generation-safe forced retirement.
    The application can acknowledge but cannot clear or extend a
    kernel-published lifecycle request.}
