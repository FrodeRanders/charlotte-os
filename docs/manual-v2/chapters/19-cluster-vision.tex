...
\begin{itemize}
    ...
    \item \texttt{notify}, which verifies a signed \texttt{CDEPLOY2}
        descriptor and commits its opaque central-object key, digest, target,
        sequence, per-thread stack pages, and capability grants without
...
\texttt{CDEPLOY2}; the reader retains compatibility with \texttt{CDEPLOY1}.
