...
completion signalling. The service calls \texttt{memory\_get\_phys} for DMA
buffers; BAR and interrupt routing are prepared by the kernel and delivered
through the bootstrap contract.
