...
attenuable. This chapter explains the capability model used for kernel-mediated
resources in CharlotteOS.
...
properties. Without capabilities, endpoints and memory objects would be anonymous
