...
AppendEntries heartbeats are coalesced. Non-Raft control messages retain their
FIFO position, preventing obsolete heartbeat backlog from starving service
retraction and invocation traffic.
