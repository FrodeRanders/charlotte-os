...
\section{Why this is better than socket-based Raft}
...
\begin{enumerate}
    \item \textbf{Consistency primitives are OS-level, not library-level.}
    ...
    \item \textbf{Timers are first-class and reliable.} An election timeout
        ...
        Kernel-managed timers delivered through the non-lossy CQ guarantee
        delivery.

    \item \textbf{Failure isolation extends to the consensus layer.} A Raft
    ...
    \item \textbf{The distributed name service is a natural extension.} Once
