...
manager, drivers, and clients. Cross-machine transport, replicated client
commands, membership changes, snapshots, durable recovery, and replication
between the name-service instance on each machine are not yet validated end
to end.
