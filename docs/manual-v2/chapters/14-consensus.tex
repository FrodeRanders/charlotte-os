...
\begin{itemize}
    \item Registers with the name service as \texttt{"raft-<id>"}.
    \item Obtains connection capabilities to its peers through the name
        service (or through seed configuration at bootstrap).
    \item Communicates with peers through endpoint IPC --- shared
    ...
    \item Reserves a client-command endpoint operation ---
