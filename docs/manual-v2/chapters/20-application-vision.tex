...
named Kafka connector profiles, and signed-deployment planning metadata. The
...
parallel-safety declaration, artifact identities, capabilities, and placement
constraints before committing desired state to the replicated manifest.
