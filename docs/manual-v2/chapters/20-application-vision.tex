...
digest-checked profile containing endpoint, trust, and future authentication
...
uses a fixed direct partition assignment and a single broker, with no consumer
group rebalance, broker failover, SASL, or compression. A generated deployment
