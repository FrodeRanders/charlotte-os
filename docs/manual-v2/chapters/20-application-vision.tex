...
signed replica/affinity policy, and deployment planning metadata. The generator creates a
...
bindings, semantic bundle admission, resource-aware and rolling placement,
lifecycle supervision, and rollback. Charlotte's lower-level signed release
path now realises fixed replica sets and exact-generation DSR readiness.
...
This binds exact executable deployment descriptors and placement policy, but
not yet the BPMN digest, schemas, communication graph, or provenance of the
proposed semantic bundle. Consuming a complete Durga process bundle still
depends on that richer binding, resource-aware scheduling, and production
