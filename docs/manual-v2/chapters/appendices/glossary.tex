...
\begin{description}
    ...
    \item[EL0] Exception Level 0 (AArch64). Userspace execution.
    ...
    \item[LP (Logical Processor)] One hardware core (or hyperthread). The unit
        of sharding in both the kernel and sitas.
    ...
    \item[TrapFrame] An architecture-specific snapshot of the user register
        state at the moment an exception was taken. Provides the caller's
        ASID for syscall dispatch.
