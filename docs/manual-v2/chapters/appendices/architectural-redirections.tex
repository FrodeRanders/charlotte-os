...
This appendix documents a design research process, recording decisions that 
redirected earlier experiments from an initial ``universal completion-capability'' 
model to the three-primitive architecture that eventually became reality. 
The earlier chapters describe the resulting implementation.
