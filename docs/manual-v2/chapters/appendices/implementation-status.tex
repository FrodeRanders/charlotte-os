...
\begin{itemize}
    ...
    \item \textbf{Live upgrade:} the EL0 service manager performs handoff and
        invokes the capability-checked replacement-domain spawn path for the
        embedded echo image. General image capabilities, multiple state
        objects, and manager-owned teardown remain future work.
