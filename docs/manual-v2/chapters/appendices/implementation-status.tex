...
\begin{itemize}
    ...
    \item \textbf{Networking:} smoltcp 0.13 adapter and TCP/IP service
        ...
        client authentication. The Kafka test also runs the generic
        ...
        the called procedure. Its connector uses a profile-selected long
        instance name, exercising named-instance plumbing rather than relying
        on the legacy global name.
