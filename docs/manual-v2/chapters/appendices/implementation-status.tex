...
\begin{itemize}
    \item \textbf{External data-service compatibility:} S3 is fixture-tested
        ...
        observes 	exttt{RDY=0} before the stronger acknowledgement. Cooperative
        cleanup in every platform service, AHCI/VirtIO-block and NIC quiescence,
        independent kernel verification of reset/IOMMU invalidation, a replicated
        shutdown intent, final poweroff, controller-managed instance leases,
        replica-aware rollout, and coordinated rollback remain future work.
