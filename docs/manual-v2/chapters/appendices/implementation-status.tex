...
12 & x86-64 multi-LP ring-3 platform: shared service ABI, synchronous TLB
    ...
    distributed DNS & Four-LP and two-guest TCG suites \\
\hline
\end{longtable}
...
\begin{itemize}
    ...
    \item \textbf{x86-64:} boots with \texttt{-cpu max} on four LPs, enters
        ...
        discovery, and two-guest distributed DNS. NVMe, AHCI, and virtio-blk
        run behind Intel VT-d or AMD-Vi. TCP/IP and HTTP boot-test registration
        remain AArch64-only.
