...
\begin{itemize}
    \item \textbf{External data-service compatibility:} S3 is fixture-tested
        ...
        and transfers hardware-root domains exactly once to an explicit
        device-quiescence boundary. Cooperative cleanup in every platform
        service, durable-flush evidence, driver reset/DMA/IOMMU quiescence, a
        replicated shutdown intent, final poweroff, controller-managed instance
        leases, replica-aware rollout, and coordinated rollback remain future
        work.
