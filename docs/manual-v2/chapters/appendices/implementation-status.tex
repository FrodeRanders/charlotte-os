...
\begin{itemize}
    \item \textbf{External data-service compatibility:} S3 is fixture-tested
        ...
        not yet qualified against an ECS installation. Kafka is limited to a
        directly assigned partition. It routes among explicitly provisioned
        brokers and refreshes leaders for produce/fetch, but still lacks full
        coordinator-migration recovery, group rebalance, additional SASL
