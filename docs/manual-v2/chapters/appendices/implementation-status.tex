...
\begin{itemize}
    \item \textbf{External data-service compatibility:} S3 is fixture-tested
        ...
        and operational connectors, with the earlier of the child and node
        deadlines enforced. Reverse-ordered platform-service and driver drain,
        final device quiescence and poweroff, controller-managed instance
