...
12 & x86-64 multi-LP ring-3 platform: shared service ABI, synchronous TLB
    shootdown, VT-d/AMD-Vi, NVMe/AHCI/virtio-blk, virtio-net, discovery, and
...
\begin{itemize}
    ...
    \item \textbf{x86-64:} boots with \texttt{-cpu max} on four LPs, enters
        ...
        idempotent installation of 26 signed service artifacts, and persistent
        restart. VMware networking is not yet supported because the current
        userspace network driver requires virtio-net; VMware presents VMXNET3
        or emulated Intel adapters instead.
    ...
    \item \textbf{Userspace drivers:} reference UART, NVMe, AHCI, virtio-blk,
        and virtio-net drivers use delegated MMIO, interrupts, and DMA domains.
