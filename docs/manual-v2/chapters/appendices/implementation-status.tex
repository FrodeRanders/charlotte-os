...
\begin{itemize}
    \item \textbf{External data-service compatibility:} S3 is fixture-tested
        ...
        standbys. It routes among explicitly provisioned
        brokers and refreshes leaders for produce/fetch, but still lacks full
        coordinator-migration recovery, conventional/cooperative assignor
        ...
        runner is implemented, but production direct capability injection,
        generation fencing, and rollout control remain controller work.
