...
Sitas (\url{https://github.com/FrodeRanders/sitas}) contributes an execution
discipline: a set of rules about how state is
owned and mutated:
...
Every other kernel facility, including completion queues, reply tokens, device
grants, and DMA mappings, is a \textbf{composition} of these three primitives.
...
Operations that cannot meaningfully block, such as capability duplication,
metadata queries, nonblocking CQ drain, and closing a quiescent object, complete
...
\section{Safety consequences and open bounds}
