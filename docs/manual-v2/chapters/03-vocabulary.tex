...
This chapter establishes the terminology used throughout this manual. Many of these terms
sound similar to concepts from other operating systems, but their CharlotteOS
...
With this vocabulary established, the following chapters build the architecture
layer by layer.
