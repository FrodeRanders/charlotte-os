...
by the kernel. Non-coherent SMMUs, ATS/PRI, multiple SMMUs, and non-AArch64
IOMMUs remain unsupported.
...
\begin{enumerate}
    ...
    \item Hardware-isolated DMA is implemented on the reference
        AArch64 SMMUv3 platform --- other IOMMU implementations and advanced
        SMMU facilities remain future work.
\end{enumerate}
