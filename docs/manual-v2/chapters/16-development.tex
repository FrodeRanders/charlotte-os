...
\begin{itemize}
    \item \textbf{Rust nightly}, installed via \texttt{rustup}. The exact
        ...
        \texttt{rust-}\allowbreak\texttt{toolchain.toml}; do not copy a version
        from this manual.
...
\hline
AArch64 custom target & Primary development target; all
    features and self-tests pass \\
x86-64 custom target & Boots, core self-tests pass;
...
\texttt{crates/catten/src/demo.rs} is an end-to-end test of the
async model. It:
