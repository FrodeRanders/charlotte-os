...
\begin{itemize}
    ...
    \item \textbf{Build dependencies:} \texttt{cargo}, \texttt{just} (optional,
        ...
        \repofiletext|Justfile|{\texttt{Justfile}}).
\end{itemize}
...
The x86-64 entry point is \repofile|scripts/boot-x86.sh|.
...
\begin{itemize}
    ...
    \item \repofiletext|crates/catten/src/self_test/el0.rs|{\texttt{el0.rs}} --- real-EL0 user thread (AArch64 only).
