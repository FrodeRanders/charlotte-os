...
\begin{enumerate}
    ...
    \item \textbf{The ABI is auditable.} The current typed
        \texttt{SyscallNumber} enum contains 56 variants across completion,
        IPC, memory, device, upgrade, and CQ operations. Userspace wrappers and
        the kernel dispatcher share this enum, and the dispatch match is
        exhaustive.
