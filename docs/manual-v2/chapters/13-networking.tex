...
\begin{itemize}
    ...
    \item \textbf{Object references:} the target architecture can represent
...
\begin{enumerate}
    \item \textbf{Remote invocation follows the local call shape.} The target API
    ...
    \item \textbf{Authority is not an address.} An application invokes a service
