...
\begin{itemize}
    ...
    \item Buffer recycling --- after the application consumes a received
        ...
        is implemented on the reference AArch64 SMMUv3 path.
\end{itemize}
...
\begin{enumerate}
    ...
    \item Copy avoidance is a design goal --- page ownership transfer can
        ...
        isolation is implemented for the reference AArch64 SMMUv3 path. No
        performance comparison with sockets has yet been established.
