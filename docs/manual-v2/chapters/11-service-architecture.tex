...
\begin{enumerate}
    ...
    \item \textbf{Stale connections.} Clients connected to the old instance
...
\begin{enumerate}
    \item \textbf{Failure containment is architectural.} A service fault closes
    ...
    \item \textbf{Recovery follows a defined sequence.} The restart sequence
