...
offset 1, next to the \texttt{basic\_kv} result at offset 0. The kernel's deferred 
verifier polls both words and reports:

\begin{verbatim}
[sitas] SUCCESS: basic_kv total_len=3 and mailbox index verified 1024 records.
\end{verbatim}
