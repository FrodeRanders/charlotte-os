...
\begin{itemize}
    ...
    \item \textbf{Data-plane producers should stop before unbounded allocation.}
...
\begin{enumerate}
    \item \textbf{The block-yield-wake cycle is exercised across subsystems.} The same
    ...
    \item \textbf{Bounded ingress limits some exhaustion paths.} Endpoint and
...
it. See \texttt{docs/observability.md} for the wire format, security boundary,
