...
/// Pages mapped at thread creation. The remaining budget is committed on
/// demand by the guard-fault path when the architecture supports it.
pub const INITIAL_USER_STACK_PAGES: usize = 1;
