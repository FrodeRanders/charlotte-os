...
///     cbz x0, drain          // if timeout: write 0xDEAD, exit
///     // ... write 0xDEAD, exit ...
/// drain:
///     poll CQ head; read entry[0].result
///     result[0]=0x9100_1500; result[1]=cap; result[2]=result
///     svc #8
/// ```
#[cfg(target_arch = "aarch64")]
const PING_CODE: &[u8] = &[
    ...
    0x0d, 0x00, 0x00, 0x14, 0x09, 0x00, 0x88, 0xd2, 0x29, 0x00, 0xa0, 0xf2, 0x2a, 0x01, 0x40, 0xb9,
    0xea, 0xff, 0xff, 0x34, 0x2b, 0x19, 0x40, 0xb9, 0x09, 0x00, 0x8a, 0xd2, 0x29, 0x00, 0xa0, 0xf2,
    0x0a, 0xa0, 0x82, 0x52, 0x2a, 0x12, 0xa0, 0x72, 0x2a, 0x01, 0x00, 0xb9, 0x33, 0x05, 0x00, 0xb9,
    0x2b, 0x09, 0x00, 0xb9, 0x01, 0x01, 0x00, 0xd4,
];
...
///     result[0..3] = sentinel, cap, read_result, buffer_val
///     svc #8
/// ```
#[cfg(target_arch = "aarch64")]
const PONG_CODE: &[u8] = &[
    ...
    0x2a, 0x02, 0xa0, 0x72, 0x2a, 0x01, 0x00, 0xb9, 0x33, 0x05, 0x00, 0xb9, 0x2b, 0x09, 0x00, 0xb9,
    0x2c, 0x0d, 0x00, 0xb9, 0x01, 0x01, 0x00, 0xd4,
];
