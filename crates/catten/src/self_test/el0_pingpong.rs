...
unsafe extern "C" {
    ...
    static __catten_el0_pong_start: u8;
...
fn stub_bytes(start: *const u8, end: *const u8) -> &'static [u8] {
    ...
    assert!(end >= start, "pp: invalid assembled stub bounds");
...
fn ping_code() -> &'static [u8] {
    stub_bytes(
        ...
        core::ptr::addr_of!(__catten_el0_ping_end),
    )
}
...
fn pong_code() -> &'static [u8] {
    stub_bytes(
        ...
        core::ptr::addr_of!(__catten_el0_pong_end),
    )
}
