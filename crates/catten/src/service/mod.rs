...
//! provides mechanism:
//!
//! - [`loader`] maps an ELF image and the standard runtime pages into a
//!   fresh user address space;
//! - [`bootstrap`] defines the config-page contract through which a spawned
//!   domain receives its initial capability;
